        ...
        <Drawer open>
            ...
            <DrawerContent>
                <DrawerHeader>
                    ...
                    <DrawerDescription>Insira seu CPF abaixo para visualizar seu pedidos</DrawerDescription>
                </DrawerHeader>               
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <DrawerFooter>
                            ...
                            <DrawerClose asChild>
                                <Button variant="secondary" className="w-full rounded-full" onClick={handleCancel}>Cancelar</Button>
                            </DrawerClose>
                        </DrawerFooter>
                    </form>
                </Form>                               
